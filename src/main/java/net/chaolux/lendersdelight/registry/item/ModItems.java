...
public class ModItems {
    ...
    static {
        ...
        HONEY_GLAZED_HORN = registerWithTab("honey_glazed_horn", () -> new StatConsumableItem(bowlFoodItem(FoodValues.HONEY_GLAZED_HORN), true,Map.of(StatType.ARMOR_BOOST,2.5f,StatType.PASSIVE_REGEN,1.0f,StatType.JUMP_BOOST,2.5f)));
        ...
        AMETHYST_CRAB_SANDWICH = registerWithTab("amethyst_crab_sandwich", () -> new StatConsumableItem(foodItem(FoodValues.AMETHYST_CRAB_SANDWICH),true,Map.of(StatType.CRIT_CHANCE,0.5f)));
        ...
        COOKED_LIONFISH = registerWithTab("cooked_lionfish", () -> new ConsumableItem(foodItem(FoodValues.COOKED_LIONFISH),true));
        ...
        CORAL_CHUNK_SANDWICH = registerWithTab("coral_chunk_sandwich", () -> new StatConsumableItem(foodItem(FoodValues.CORAL_CHUNK_SANDWICH),true,Map.of(StatType.SWIM_SPEED,0.7f)));
        CORAL_GOLEM_MEAT = registerWithTab("coral_golem_meat", () -> new StatConsumableItem(foodItem(FoodValues.CORAL_GOLEM_MEAT),true,Map.of(StatType.CRIT_CHANCE,0.3f)));
        ...
        CRYSTALLIZED_CORAL_ROLL = registerWithTab("crystallized_coral_roll", () -> new StatConsumableItem(foodItem(FoodValues.CRYSTALLIZED_CORAL_ROLL),true,Map.of(StatType.ATTACK_SPEED,0.2f)));
        AMETHYST_CRAB_MEAT_SLICE = registerWithTab("amethyst_crab_meat_slice", () -> new ConsumableItem(foodItem(FoodValues.AMETHYST_CRAB_MEAT_SLICE),true));
        COOKED_AMETHYST_CRAB_MEAT_SLICE = registerWithTab("cooked_amethyst_crab_meat_slice", () -> new ConsumableItem(foodItem(FoodValues.COOKED_AMETHYST_CRAB_MEAT_SLICE),true));
        CORAL_CHUNK_RED_SLICE = registerWithTab("coral_chunk_red_slice", () -> new ConsumableItem(foodItem(FoodValues.CORAL_CHUNK_RED_SLICE),true));
        MALEDICTUS_HEART_SLICE = registerWithTab("maledictus_heart_slice", () -> new StatConsumableItem(foodItem(FoodValues.MALEDICTUS_HEART_SLICE),true,Map.of(StatType.ATTACK_BOOTS,3.5f)));
        DEEPLING_MEAT = registerWithTab("deepling_meat", () -> new StatConsumableItem(foodItem(FoodValues.DEEPLING_MEAT),true,Map.of(StatType.SWIM_SPEED,0.5f)));
        ...
        RAW_DEEPLING_MEAT = registerWithTab("raw_deepling_meat", () -> new StatConsumableItem(foodItem(FoodValues.RAW_DEEPLING_MEAT),true,Map.of(StatType.SWIM_SPEED,0.3f)));
        RAW_BRUTE_DEEPLING_MEAT = registerWithTab("raw_brute_deepling_meat", () -> new StatConsumableItem(foodItem(FoodValues.RAW_DEEPLING_MEAT),true,Map.of(StatType.SWIM_SPEED,0.3f)));
        RAW_WARLOCK_DEEPLING_MEAT = registerWithTab("raw_warlock_deepling_meat", () -> new StatConsumableItem(foodItem(FoodValues.RAW_DEEPLING_MEAT),true,Map.of(StatType.SWIM_SPEED,0.3f)));
        ...
        CRYSTALLIZED_CORAL_PIE_SLICE = registerWithTab("crystallized_coral_pie_slice", () -> new StatConsumableItem(foodItem(FoodValues.CRYSTALLIZED_CORAL_PIE_SLICE),true,Map.of(StatType.ATTACK_SPEED,0.3f)));
