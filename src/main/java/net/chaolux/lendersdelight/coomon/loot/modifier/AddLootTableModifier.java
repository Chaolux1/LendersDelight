...
public class AddLootTableModifier {
    ...
    public static void onLootTableLoad(LootTableLoadEvent event) {
        ...
        if(event.getName().equals(ResourceLocation.fromNamespaceAndPath("cataclysm","entities/deepling")) || event.getName().equals(ResourceLocation.fromNamespaceAndPath("cataclysm","entities/deepling_angler")) || event.getName().equals(ResourceLocation.fromNamespaceAndPath("cataclysm","entities/deepling_priest"))) {
        ...
        if(event.getName().equals(ResourceLocation.fromNamespaceAndPath("cataclysm","entities/deepling_brute"))) {
        ...
        if(event.getName().equals(ResourceLocation.fromNamespaceAndPath("cataclysm","entities/deepling_warlock"))) {
        ...
        if(event.getName().equals(ResourceLocation.fromNamespaceAndPath("cataclysm","entities/cindaria"))) {
        ...
        if(event.getName().equals(ResourceLocation.fromNamespaceAndPath("cataclysm","entities/clawdian"))) {
        ...
        if(event.getName().equals(ResourceLocation.fromNamespaceAndPath("cataclysm","entities/hippocamtus"))) {
        ...
        if(event.getName().equals(ResourceLocation.fromNamespaceAndPath("cataclysm","entities/scylla"))) {
        ...
        if(event.getName().equals(ResourceLocation.fromNamespaceAndPath("cataclysm","entities/symbiocto"))) {
        ...
        if(event.getName().equals(ResourceLocation.fromNamespaceAndPath("cataclysm","entities/urchinkin"))) {
